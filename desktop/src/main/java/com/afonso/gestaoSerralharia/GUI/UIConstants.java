...
public final class UIConstants {
    ...
    public static final int    SIDEBAR_PAD_H        = 8;
    public static final int    SIDEBAR_PAD_V        = 8;
    public static final int    SIDEBAR_SECTION_TOP  = 12;
    public static final int    SIDEBAR_SECTION_BOT  = 3;
    public static final int    SIDEBAR_LOGO_PAD_V   = 14;
    public static final int    SIDEBAR_FOOTER_PAD_V = 10;
